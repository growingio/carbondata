        ...
        if (dicts(index) != null) {
          ...
          if (CarbonDataTypes.isDecimal(getDictionaryColumnIds(index)._3.getDataType)) {
            ...
            CarbonToSparkAdapter.createExprCode(
              code, s"$value.getIsNull()",
              s"((org.apache.spark.sql.types.Decimal)$value.getValue())", expr.dataType
            )
          } else {
            getDictionaryColumnIds(index)._3.getDataType match {
              case CarbonDataTypes.INT => code +=
                s"""
                 ...
                 """.stripMargin
                CarbonToSparkAdapter.createExprCode(
                  code, s"$value.getIsNull()", s"((Integer)$value.getValue())", expr.dataType
                )
              case CarbonDataTypes.SHORT => code +=
                s"""
                 ...
                 """.stripMargin
                CarbonToSparkAdapter.createExprCode(
                  code, s"$value.getIsNull()", s"((Short)$value.getValue())", expr.dataType
                )
              case CarbonDataTypes.DOUBLE => code +=
                 ...
                 """.stripMargin
                CarbonToSparkAdapter.createExprCode(
                  code, s"$value.getIsNull()", s"((Double)$value.getValue())", expr.dataType
                )
              case CarbonDataTypes.LONG => code +=
                 ...
                 """.stripMargin
                CarbonToSparkAdapter.createExprCode(
                  code, s"$value.getIsNull()", s"((Long)$value.getValue())", expr.dataType
                )
              case _ => code +=
                s"""
                 ...
                 """.stripMargin
                CarbonToSparkAdapter.createExprCode(
                  code, s"$value.getIsNull()", s"((UTF8String)$value.getValue())", expr.dataType
                )
            }
          }
